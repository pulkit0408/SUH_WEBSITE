...
const WhatsAppFloat = () => {
  ...
  const handleWhatsAppClick = () => {
    const phoneNumbers = ["919211056355", "917596818126"]; // No spaces, with country code
    const message = "Hi! I'd like to get connected.";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center">
      {/* Tooltip */}
      <div
        className={`bg-white rounded-lg shadow-lg px-4 py-3 mr-3 transition-all duration-300 ${
