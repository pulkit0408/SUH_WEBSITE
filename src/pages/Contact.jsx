...
const ContactUsPage = () => {
  ...
  const handleLinkedInClick = () => {
    window.open('https://linkedin.com/company/agency', '_blank');
  };
      ...
      <div className="max-w-7xl mx-auto">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8">
                    <div className="transform transition-all duration-500 group-hover:translate-y-0 translate-y-2">
                      ...
                      <p className="text-gray-200 text-sm sm:text-base mb-4 leading-relaxed">
                        From concept to completion, our team is dedicated to bringing your vision to life with creativity and precision.
                      </p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
              ...
              >
                ...
                <p className="text-gray-300 text-sm">hello@agency.com</p>
              </div>
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-gray-300 mb-8 leading-relaxed">
              We're here to help you every step of the way. From initial consultation to final delivery,
              our team ensures your project exceeds expectations.
            </p>
          </div>
        </div>
      </div>
