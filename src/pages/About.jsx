...
const About = () => {
  ...
  return (
    <>
      <div
        id="about"
        className="flex items-center justify-center gap-8 p-8 overflow-hidden lg:flex-row flex-col"
      >
        ...
        <div className="flex items-center justify-center flex-col max-w-[548px] lg:items-start">
          <div className="flex items-center justify-center gap-3 flex-col lg:items-start">
            ...
            <p className="text-white/95 font-normal leading-8 text-md text-center lg:text-left">
              At SUH TECH PRIVATE LIMITED, we specialize in delivering
              innovative technology solutions that drive business success. From
              product development and digital marketing to game design and
              startup consultancy, we combine expertise with passion to create
              impactful results. We value your time — and your vision.
            </p>
          </div>
