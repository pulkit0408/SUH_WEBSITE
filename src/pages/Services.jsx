...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      paragraph: "Protect your business from digital threats. Our cybersecurity experts implement robust security measures, conduct vulnerability assessments, and provide ongoing monitoring to keep your data safe."
    }
  ];
  ...
  return (
    <>
      <div className="flex items-center justify-baseline flex-col gap-12 py-25 px-4 sm:px-8 lg:px-20 overflow-hidden">
        <div className="flex flex-col items-center justify-center text-center p-4 gap-4">
          ...
          <p className="text-white/95 font-normal leading-6 sm:leading-8 text-sm sm:text-base text-center max-w-4xl">
            We create designs and solutions that make your brand unforgettable, combining{' '}
        ...
        <div className="w-full overflow-hidden">
          <div
            ref={scrollRef}
            className={`flex gap-8 ${isPaused ? 'animate-scroll-paused' : 'animate-scroll'}`}
            style={{
