...
const HeroSection = () => {
  ...
  return (
    <section id="home" className="relative overflow-hidden pt-20 pb-24 sm:pt-24 sm:pb-32">
      <div className="relative z-0">
        <img
          src="Vector 642.svg"
          alt="background"
          className="absolute top-0 left-0 w-auto h-auto max-w-[150px] sm:max-w-[200px] lg:max-w-none -translate-y-1/2 -translate-x-1/2 sm:-translate-x-1/4 opacity-70"
        />

        <img
          src="Frame.png"
          alt="rectangle"
          className="hidden sm:block absolute bottom-40 left-0 w-auto h-auto max-w-[150px] sm:max-w-[200px] lg:max-w-none opacity-70"
        />

        <img
          src="Vector 643.svg"
          alt="background"
          className="absolute top-0 right-0 w-auto h-auto max-w-[150px] sm:max-w-[200px] lg:max-w-none translate-y-1/2 translate-x-1/2 sm:translate-x-1/4 opacity-70"
        />
      </div>

      <div
        className={`relative z-20 flex flex-col items-center justify-center text-center px-4 sm:px-6 transition-all duration-1000 ${
        ...
        <div className="max-w-4xl mx-auto w-full">
          ...
          <div className="mb-4 sm:mb-6">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white leading-tight">
              Your End-to-End{" "}
              <span
                className="bg-gradient-to-r from-pink-500 via-blue-500 to-pink-500 bg-clip-text text-transparent inline-block md:inline animate-pulse"
                style={{
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed px-2">
            ...
            <span className="sm:hidden"> </span>— helping businesses innovate,
            grow, and stay ahead.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-16 px-2">
            ...
            {/* Contact Button */}
            <button
              className="px-6 sm:px-8 py-3 sm:py-4 border-2 border-white/30 w-full sm:w-56 h-12 sm:h-14 rounded-2xl text-white font-semibold backdrop-blur-sm transition-all duration-300 relative overflow-hidden group hover:scale-105 hover:-translate-y-1 active:scale-95 hover:border-white/50 hover:bg-white/10"
              onClick={() => {
